...
import BookLibrary from './BookLibrary'; // Book display component
import { useGetBooksQuery } from '../slices/bookApi'; // path to your apiSlice
    ...
    <div className="relative w-[90%] h-[406px] top-[134px] left-[32px] rounded-[20px] overflow-hidden mx-auto">
      ...
      <div className="relative z-10 w-full h-full flex items-center justify-between px-16">
        <div className="grid gap- max-w-[60%]">
          <h1 className="font-[Zain] font-bold text-[52px] text-[#D5A83A] shadow-[4px_4px_20px_#FFFFFF33]">A Universe of Stories</h1>
          <h2 className="font-[Zain] font-bold text-[40px] text-[#00BDB0] shadow-[4px_4px_20px_#FFFFFF33]">at Your Fingertips</h2>
      ...
      <div className="w-[45%] mx-auto mt-24 flex justify-around mx-auto">
