    ...
    <div>
      ...
      <div className="w-[70%] mx-auto flex justify-between">
        <div className="grid gap-4">
          <h1 className="text-[#00BAC7] font-[zain] font-extrabold text-[128px]">
            Rent
          </h1>
          <h2 className="text-[#000000] font-[zain] font-extrabold text-[64px]">
            the Stories You Love
          </h2>
          <p className="text-[#000000] font-[zain] font-400 text-[32px]">
            Enjoy full access to the books you want — without the full price.
            <br />
            With flexible rentals, you can read on your terms and return when
            youre done.
            <br />
            Perfect for trying new titles or diving into short reads.
          </p>
          <button className="text-white font-[zain] font-400 text-[24px] bg-[#00BAC7] rounded-[10px] p-4 w-[150px]">
            Start Renting
          </button>
        </div>
